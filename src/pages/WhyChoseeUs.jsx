  ...
  return (
    ...
    >
      ...
      <div className="relative z-[2] mx-2 my-5 grid grid-cols-1 gap-5 md:mx-10 md:grid-cols-1 md:gap-12 lg:mx-20">
        {
            data.map((item,idx)=>(
                        <div className="flex cursor-pointer rounded-xl border border-[#2b2b2b] bg-[#1f1f1f] p-5 py-5 hover:scale-[1.02]" key={idx}>
                          <span className="justify-left flex w-1/2 items-center text-center text-4xl lg:text-3xl">
                            {item.title}
                          </span>
