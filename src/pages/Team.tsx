...
const Team = () => {
  ...
  return (
    <div className='relative h-fit w-full overflow-x-hidden px-2 py-5 md:px-10 lg:px-20'>
      <div className='absolute -right-1 z-[1] hidden aspect-square rounded-full border border-[#2b2b2b] bg-gridBg hover:bg-[#1c1c1c] md:block md:w-[45vw] lg:w-[20vw]'></div>
      <div className="relative z-[2]">
        <div className='mb-10 w-fit rounded-lg bg-[#1f1f1f] px-10 py-1 text-xl'>Team</div>
        <h1 className='mb-8 text-center text-3xl md:text-5xl lg:text-6xl'>Meet Our </h1>
